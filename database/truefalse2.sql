...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Nov 2021 pada 10.51
...
(5, 0, 0, 'TRUE', 'Bagaimana kabar kalian ?', 26, 15, 0),
(6, 0, 0, 'TRUE', 'Andai kau bisa mengerti betapa beratnya aku ?', 19, 15, 0),
(7, 0, 0, 'TRUE', 'Mengapa bukan kamu yg memiliki aku ?', 9, 5, 0),
(12, 0, 0, 'TRUE', 'Ini gimana cara bikin trigger mysql kok lupa wkwk\r\n', 0, 0, 0),
(14, 0, 0, 'TRUE', 'How could u be so reckless with someone heart ?', 0, 0, 0),
(17, 0, 0, 'TRUE', 'Apakah minggu depan gajian ?', 3, 1, 0),
(21, 0, 0, 'TRUE', 'Besok presentasi ke pak usman ?', 0, 2, 0),
(23, 0, 0, 'FALSE', 'Yeay bisa', 1, 1, 0),
(31, 0, 0, 'FALSE', 'Aman kah ?', 1, 1, 0),
(32, 0, 0, 'TRUE', 'Ini pertanyaan baru hehe', 2, 1, 0);
